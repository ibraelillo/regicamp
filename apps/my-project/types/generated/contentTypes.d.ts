...
export interface ApiArticleArticle extends Schema.CollectionType {
  ...
  attributes: {
    ...
    type: Attribute.Enumeration<['publiredac', 'actu', 'sponsored']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    sections: Attribute.Component<'articles.section', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiContractContract extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    managedBy: Attribute.Relation<
      'api::contract.contract',
      'oneToOne',
      'admin::user'
    >;
    specifics: Attribute.DynamicZone<
      ['contracts.linknet', 'contracts.valorized-linknet', 'contracts.video']
    > &
      Attribute.SetMinMax<{
        min: 1;
        max: 1;
...
export interface ApiContratThematiqueContratThematique
  extends Schema.CollectionType {
  ...
  attributes: {
    announcer: Attribute.Relation<
      'api::contrat-thematique.contrat-thematique',
      'oneToOne',
      'api::organization.organization'
    >;
    start: Attribute.Date & Attribute.Required;
    end: Attribute.Date;
    items: Attribute.Component<'contracts.contrat-thematique-item', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiFooterFooter extends Schema.SingleType {
  ...
  attributes: {
    ...
    partners: Attribute.Component<'basic.logo', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    social_networks: Attribute.Component<'basic.logo', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    newsletter_placeholder: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    newsletter_cta: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiOrganizationOrganization extends Schema.CollectionType {
  ...
  attributes: {
    ...
    type: Attribute.Enumeration<
      ['person', 'partner', 'association', 'city', 'touristic_site']
    >;
    name: Attribute.String;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::contrat-thematique.contrat-thematique': ApiContratThematiqueContratThematique;
